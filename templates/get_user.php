          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Users</h3>
                ...
                <!-- <a id="sell_add" style="color: #FFF;" href="add_user.php"><div class="btn btn-info" style="margin: 5px 30px 5px;">
                     Add
                  </div></a> -->
	 ...
	 <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="tblTaxList">
               <thead>
                  ...
                  <th><?php echo $ln_user_name;?></th>
                  <th><?php echo $ln_user_type;?></th>
...
var num_display_entries,items_per_page,num_entries,start;
    function pageselectCallback(page_index, jq, event_type){
     ...
     function loadData(start,per_page,event_type){
        ajaxloader.loadURL('ajax/get_user.php', {start:start,search:$('#search').val()}, function(res){
                 ...
                 var tr = '';
                  $.each(result, function(index, item){
                          tr += "<tr>\
                                     ...
                                     <td>"+item.status+"</td>\
                                     <td><a class='fa fa-fw fa-edit' href='user_edit.php?user_id="+item.id+"''></a></td>\
                                     </tr>";
                  });
